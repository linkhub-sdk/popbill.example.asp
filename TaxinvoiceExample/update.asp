...
<%
	...
	newTaxinvoice.writeDate = "20150121"             '필수, 기재상 작성일자
    ...
    newTaxinvoice.invoicerMgtKey = "20150122-01"    '공급자 연동관리번호(Update시 변경되지않음)
    newTaxinvoice.invoicerCEOName = "공급자 대표자 성명"
    newTaxinvoice.invoicerAddr = "공급자 주소수정"
    newTaxinvoice.invoicerBizClass = "공급자 업종수정"
