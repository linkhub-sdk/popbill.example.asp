...
<%
    ...
    ' - https://docs.popbill.com/taxinvoice/asp/api#RegistContact
    '**************************************************************
    ...
    Set Presponse = m_TaxinvoiceService.RegistContact(CorpNum, contInfo, UserID)
