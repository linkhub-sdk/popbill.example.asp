...
<%
    ...
    newTaxinvoice.invoicerMgtKey = "20160126-09"		'공급자 파트너 관리번호, 발행자별 고유번호 할당, 1~24자리 영문,숫자조합으로 중복없이 구성.
    ...
    newTaxinvoice.invoiceeEmail1 = "test@test.com"
	...
	'RegistIssue(팝빌회원 사업자번호, 전자세금계산서 객체, 거래명세서 동시작성여부, 거래명세서 관리번호, 지연발행 강제여부, 메모, 발행안내 메일제목, 팝빌회원 아이디)
	Set Presponse = m_TaxinvoiceService.RegistIssue(testCorpNum, newTaxinvoice, writeSpecificationYN, dealInvoiceMgtKey, forceIssue, memo, emailSubject, userID)
