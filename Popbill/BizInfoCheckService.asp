...
'기업정보조회 단건
Public Function CheckBizInfo(MemberCorpNum, CorpNum) 
    ...
    Dim result : Set result = m_PopbillBase.httpGet("/BizInfo/Check?CN="+CorpNum, m_PopbillBase.getSession_token(MemberCorpNum),"")
