...
<%
    ...
    ' - https://developers.popbill.com/reference/accountcheck/asp/api/member#GetContactInfo
    '**************************************************************
    ...
    Set conInfo = m_AccountCheckService.GetContactInfo(testCorpNum, contactID ,userID)
